...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-5">Tabla datos fijos</h1>
    <div class="row">
        <div class="col-3">
            <select id="selectPosition" class="form-select mb-3" aria-label="Default select example">
        ...
        <div class="col-3">
            <select id="selectOffice" class="form-select mb-3" aria-label="Default select example">
    ...
    <table id="example" class="table table-striped table-bordered table-hover shadow" style="width:100%">
        <thead>
        <tr>
            <th>Name</th>
            <th>Position</th>
    ...
    <h1 class="text-center mt-5">Tabla con API - AJAX</h1>
    <table id="myTableApi" class="table table-striped table-bordered table-hover shadow" style="width:100%">
        <thead>
        <tr>
            <th>USER ID</th>
            <th>ID</th>
    ...
    <h1 class="text-center mt-5">Tabla con API 1 - JavaScript</h1>
    <table id="myTableAPI1" class="table table-striped table-bordered table-hover shadow" style="width:100%"></table>
